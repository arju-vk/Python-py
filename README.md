...
<h3>AND</h3>: Returns true only if both conditions are true. <br>
<h3>OR</h3>: Returns true if at least one condition is true. <br>
<h3>XOR</h3>: Returns true if exactly one condition is true. (exclusive or)<br>
<h3>NOT</h3>: Inverts the value - true becomes false, false becomes true. <br>
